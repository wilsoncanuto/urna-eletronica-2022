...
function candidatos(){
    ...
    if (valor1 === 1 & valor2 === 0){
        ...
        document.getElementById("candidato").innerHTML= '<img src="./img/30.webp" height="290px" max-width="300px">';
        ...
        document.getElementById("candidato").innerHTML= '<img src="./img/50.jpeg" height="290px" max-width="300px">';
    } else {
